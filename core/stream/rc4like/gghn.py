...
class GGHN:
    ...
    def BeginState(self, key, a):
        ...
        for t in range(1, self.n + 1):
            ...
            bState.k = (bState.k +  bState.b[bState.i]) % self.m
        bState.i = 0
        bState.j = 0
        return bState
    ...
    def Next(self):
        ...
        self.state.k = (self.state.k + self.state.b[self.state.j]) % self.m
        self.state.transposition(self.state.i, self.state.j)
        z = (self.state.b[(self.state.b[self.state.i] + self.state.b[self.state.j]) % self.n] + self.state.k) % self.m
        self.state.b[(self.state.b[self.state.i] + self.state.b[self.state.j]) % self.n] = (self.state.b[self.state.i] + self.state.k) % self.m
        return z
